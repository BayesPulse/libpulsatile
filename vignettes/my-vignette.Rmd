...
-There are fxs in BayesPulse/libpulsatile that we've never used--which of these should be included in this vignette?
-Is it okay if I push this to actual GitHub? I feel like it has to be at some point, but I was nervous to do that in case that's wrong... (but I need to either create another repo for this or push to GH/BP or I won't be able to add in and test the functions from the other computer)
