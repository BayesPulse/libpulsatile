...
A graphic demonstration of the deconvolution model is shown in Figure 1.


![\textbf{Figure 1} Example observed and actual ('truth') hormone concentrations as defined by the deconvolution model.](images/deconvolution.png)
