...
#' @param prior_mass_p2p_prec  Scale of the Half-Cauchy prior on the standard deviation of pulse-to-pulse variation of masses for a patient
...
pop_spec <- function(prior_mass_mean = 3.5,
                     prior_mass_var = 100,
                     prior_mass_s2s_sd = 1,
                     prior_mass_p2p_prec = 0.001,
                     prior_mass_p2p_prec_rate = 0.001,
                     prior_width_mean = 25,
                     prior_width_var = 1000,
                     prior_width_s2s_sd = 1,
                     prior_width_p2p_prec = 0.001,
                     prior_width_p2p_prec_rate = 0.001,
    ...
    structure(
      list(#location_prior = location_prior_type,
           priors = list(mass_mean               = prior_mass_mean,
                         ...
                         mass_p2p_prec           = prior_mass_p2p_prec,
                         mass_p2p_prec_rate      = prior_mass_p2p_prec_rate,
                         mass_s2s_sd             = prior_mass_s2s_sd,
                         width_mean              = prior_width_mean,
                         width_var               = prior_width_var,
                         width_p2p_prec          = prior_width_p2p_prec,
                         width_p2p_prec_rate     = prior_width_p2p_prec_rate,
