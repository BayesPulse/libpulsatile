...
fit_pop_pulse <- function(data,
                          ...
                          verbose_iter = 5000,
                          fix_params = c("mass_p2p_sd", "width_p2p_sd"),
  ...
  param_list <- c("pop_mass_mean", "pop_width_mean", "pop_baseline_mean", 
                  ...
                  "baseline_s2s_sd","halflife_s2s_sd", "mass_p2p_prec",
                  "width_p2p_prec", "pat_mass_mean", "pat_width_mean",
...
pop_param_validation <- function(data, time, conc, location_prior, spec, iters, thin,
  ...
  param_list <- c("pop_mass_mean", "pop_width_mean", 
                  ...
                  "mass_p2p_prec", "width_p2p_prec", "pat_mass_mean", 
