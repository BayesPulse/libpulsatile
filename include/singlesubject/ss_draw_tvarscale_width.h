#ifndef GUARD_ss_draw_tvarscalewidths_h
#define GUARD_ss_draw_tvarscalewidths_h
...
class SS_DrawTVarScaleWidths : public ModifiedMetropolisHastings<PulseEstimate, Patient, double, ProposalVariance>
{
...
double SS_DrawTVarScaleWidths::posterior_function(PulseEstimate *pulse, 
                                            double proposal, 
                                            Patient *patient) {
