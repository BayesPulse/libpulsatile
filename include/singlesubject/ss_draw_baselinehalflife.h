...
class SS_DrawBaselineHalflife : public ModifiedMetropolisHastings<Patient, Patient, arma::vec, ProposalVariance2p>
{
  ...
  public:
    ...
    SS_DrawBaselineHalflife(arma::vec in_pv, // double or arma::vec
      ...
      <Patient, Patient, arma::vec,
      ProposalVariance2p>::ModifiedMetropolisHastings(in_pv,
                                                      in_adjust_iter,
                                                      in_max_iter,
                                                      in_target_ratio) { };
  ...
  private:
    ...
    bool parameter_support(arma::vec val, Patient *patient) { 
      return ( val(0) > 0.0 && val(1) > 0.0 ); 
    }

    double posterior_function(Patient *patient, arma::vec proposal, Patient *notused) {
