...
silent only
cd ~/Projects/BayesPulse/poppulsatile
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 test_and_build.R
badd +5 src/metropolishastings/mh.cpp
badd +1 src/metropolishastings/mh.h
badd +84 src/metropolishastings/proposalvariance.cpp
badd +43 src/metropolishastings/proposalvariance.h
badd +2 src/patient_classes/patient.cpp
badd +91 src/patient_classes/patient.h
badd +0 R_doc2
badd +0 src/population_math/p_hlbase.cpp
badd +496 ../poppulsepaper/Pop-UnifLogNormPrior/src/pop_mcmc.c
argglobal
silent! argdel *
$argadd test_and_build.R
set stal=2
edit src/metropolishastings/mh.h
...
exe 'vert 2resize ' . ((&columns * 142 + 104) / 208)
exe 'vert 3resize ' . ((&columns * 33 + 104) / 208)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 108 - ((51 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists('src/metropolishastings/proposalvariance.h') | buffer src/metropolishastings/proposalvariance.h | else | edit src/metropolishastings/proposalvariance.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 44 - ((33 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
exe 'vert 2resize ' . ((&columns * 142 + 104) / 208)
exe 'vert 3resize ' . ((&columns * 33 + 104) / 208)
tabedit src/population_math/p_hlbase.cpp
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 87 + 104) / 208)
argglobal
...
wincmd w
exe 'vert 1resize ' . ((&columns * 87 + 104) / 208)
tabedit src/patient_classes/patient.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 158 + 104) / 208)
exe 'vert 2resize ' . ((&columns * 159 + 104) / 208)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
4
normal! 0
lcd ~/Projects/BayesPulse/poppulsatile
wincmd w
argglobal
if bufexists('~/Projects/BayesPulse/poppulsatile/src/patient_classes/patient.h') | buffer ~/Projects/BayesPulse/poppulsatile/src/patient_classes/patient.h | else | edit ~/Projects/BayesPulse/poppulsatile/src/patient_classes/patient.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 44 - ((42 * winheight(0) + 45) / 91)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
exe 'vert 1resize ' . ((&columns * 158 + 104) / 208)
exe 'vert 2resize ' . ((&columns * 159 + 104) / 208)
tabedit ~/Projects/BayesPulse/poppulsatile/src/metropolishastings/proposalvariance.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 37 - ((29 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
wincmd w
argglobal
if bufexists('~/Projects/BayesPulse/poppulsatile/src/metropolishastings/proposalvariance.h') | buffer ~/Projects/BayesPulse/poppulsatile/src/metropolishastings/proposalvariance.h | else | edit ~/Projects/BayesPulse/poppulsatile/src/metropolishastings/proposalvariance.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 57 - ((56 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
