...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(singlesubject_(concentration, time, inpriors, proposalvars, startingvals, mcmc_iterations, thin, burnin, verbose, pv_adjust_iter, pv_adjust_max_iter, bivariate_pv_target_ratio, univariate_pv_target_ratio));
